...
- Data loader semantics: local OpenSGG JSON is not an exact official H5 loader
  clone because of zero-relation filtering, duplicate-relation collapse, and
  integer box rounding.
- Full-VG metric after the PE-NET official `600/1000` eval resize opt-in has
  not yet been rerun.
