...
- Preprocessing mismatch: local OpenSGG VisualGenome eval uses
  `RandomResize([800], max_size=1333)`, while the official PENET config uses
  `INPUT.MIN_SIZE_TEST = 600` and `INPUT.MAX_SIZE_TEST = 1000`.
