...
def create_parser():
    ...
    # dataset parameters
    parser.add_argument(
        "--batch_size", "-b", default=None, type=int, help="Training batch size"
    )
    parser.add_argument(
        "--val_batch_size", "-vb", default=None, type=int, help="Validation batch size"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--lr", default=None, type=float, help="Learning rate (default: 1e-3)"
    )
    parser.add_argument(
        "--lr_k_decay",
        type=float,
    ...
    parser.add_argument(
        "--prototype_path",
        default="data/VisualGenome/clip_prototypes.pth",
        type=str,
    ...
    parser.add_argument(
        "--clip_dim", default=512, type=int, help="CLIP text embedding dimension"
    )
    parser.add_argument(
